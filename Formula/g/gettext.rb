class Gettext < Formula
  ...
  url "https://ftp.gnu.org/gnu/gettext/gettext-0.22.tar.gz"
  mirror "https://ftpmirror.gnu.org/gettext/gettext-0.22.tar.gz"
  mirror "http://ftp.gnu.org/gnu/gettext/gettext-0.22.tar.gz"
